...
@NamedQueries({
    ...
    @NamedQuery(name = "FeedbackDes.findByDesignerID", query = "SELECT f FROM FeedbackDes f WHERE f.designerID.designerID = :designerID"), // New query to find by DesignerID
